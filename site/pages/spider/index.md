...
The `SpiderServer` is the core HTTP/1.1 server implementation. It uses `java.net.ServerSocket` with virtual threads for
...
based on file extensions when using `FileHandler`.
...
### Integrating WebSockets with SpiderServer
