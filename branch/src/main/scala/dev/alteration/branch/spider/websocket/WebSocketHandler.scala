...
object WebSocketHandler {
  ...
  /** Handle a WebSocket connection by calling onConnect and running the message
    * loop.
    *
    * This is a public helper method that can be called from outside the
    * websocket package. It encapsulates the standard pattern of connecting and
